      ...
      <main className="p-4 pb-24 relative z-10">
        ...
        <div ref={localRef} className="bg-white rounded-card border border-border shadow-subtle p-6 mb-8 text-center">
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            ...
            <a href={`https://maps.google.com/?q=${encodeURIComponent(eventAddress)}`} className="flex flex-col items-center gap-2 p-3 bg-secondary hover:bg-border rounded-xl transition"><GoogleMapsLogo /><span className="text-xs font-medium text-accent">Maps</span></a>
          </div>
        </div>
